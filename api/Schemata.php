...
class Schemata
{
    ...
    static public $schemata = [
        ...
        6205 => [
            ...
            "postnr" => ["postnr", false, "int"],
            "adr_id" => ["adr_id", false, "uuid"],
            "koordinat_north" => ["koordinat_north", false, "varchar"],
            "koordinat_east" => ["koordinat_east", false, "varchar"],
            "sagsnr" => ["sagsnr", false, "varchar"],
            "ejendomsnummer" => ["ejendomsnummer", false, "int"],
            "bygningsnummer" => ["bygningsnummer", false, "int"],
            "matrikel_ejerlav" => ["matrikel_ejerlav", false, "varchar"],
            "opfoerelsesaar" => ["opfoerelsesaar", false, "int"],
            "anvendelse" => ["anvendelse", false, "varchar"],
            "bbr_uuid" => ["bbr_uuid", false, "uuid"],
            "bygningsnavn" => ["bygningsnavn", false, "varchar"],
            "bygningsnotat" => ["bygningsnotat", false, "varchar"],
            "objekt" => ["objekt", false, "varchar"],
            "registreringsproblem" => ["registreringsproblem", false, "varchar"],
            "komplekstype" => ["komplekstype", false, "varchar"],
            "oprindelig_funktion" => ["oprindelig_funktion", false, "varchar"],
            "vurderingsbaseline" => ["vurderingsbaseline", false, "varchar"],
            "bygningsdel" => ["bygningsdel", false, "varchar"],
            "doereporte" => ["doereporte", false, "varchar"],
            "gavlkonstruktion" => ["gavlkonstruktion", false, "varchar"],
            ...
            "tagkonstruktion" => ["tagkonstruktion", false, "varchar"],
            "udsmykning" => ["udsmykning", false, "varchar"],
            "vindue" => ["vindue", false, "varchar"],
            "ydermur" => ["ydermur", false, "varchar"],
            "bebyggelsesmiljoe" => ["bebyggelsesmiljoe", false, "varchar"],
            "ydre_forhold" => ["ydre_forhold", false, "varchar"],
            "indre_forhold" => ["indre_forhold", false, "varchar"],
            "omgivelser" => ["omgivelser", false, "varchar"],
            "arkitektonisk_vaerdi" => ["arkitektonisk_vaerdi", false, "int"],
            "arkitektonisk_vurdering" => ["arkitektonisk_vurdering", false, "varchar"],
            "kulturhistorisk_vaerdi" => ["kulturhistorisk_vaerdi", false, "int"],
            "kulturhistorisk_vurdering" => ["kulturhistorisk_vurdering", false, "varchar"],
            "miljoemaessig_vaerdi" => ["miljoemaessig_vaerdi", false, "int"],
            "miljoemaessig_vurdering" => ["miljoemaessig_vurdering", false, "varchar"],
            "originalitetsvaerdi" => ["originalitetsvaerdi", false, "int"],
            "originalitetsvurdering" => ["originalitetsvurdering", false, "varchar"],
            "tilstandsvaerdi" => ["tilstandsvaerdi", false, "int"],
            "tilstandsvurdering" => ["tilstandsvurdering", false, "varchar"],
            "bevaringsmaessig_vaerdi" => ["bevaringsmaessig_vaerdi", false, "int"],
            "bevaringsmaessig_vurdering" => ["bevaringsmaessig_vurdering", false, "varchar"],
            "registreringsdato" => ["registreringsdato", false, "date"],
            "registrator" => ["registrator", false, "varchar"],
            "bevaringsvaerdig" => ["bevaringsvaerdig", false, "bool"],
            "bevaringsaarsag_kode" => ["bevaringsaarsag_kode", true, "int"],
