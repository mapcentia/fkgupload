    ...
    static public $schemata = [
        ...
        6122 => [
            ...
            6205 => [
                ...
                "arkitektonisk_vurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "kulturhistorisk_vaerdi" => ["arkitektonisk_vaerdi", false, "int"],
                "kulturhistorisk_vurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "miljoemaessig_vaerdi" => ["arkitektonisk_vaerdi", false, "int"],
                "miljoemaessig_vurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "originalitetsvaerdi" => ["arkitektonisk_vaerdi", false, "int"],
                "originalitetsvurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "tilstandsvaerdi" => ["arkitektonisk_vaerdi", false, "int"],
                "tilstandsvurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "bevaringsmaessig_vaerdi" => ["arkitektonisk_vaerdi", false, "int"],
                "bevaringsmaessig_vurdering" => ["arkitektonisk_vaerdi", false, "varchar"],
                "registreringsdato" => ["arkitektonisk_vaerdi", false, "date"],
                "registrator" => ["gr_regnavn", false, "varchar"],
                "bevaringsvaerdig" => ["bevaringsvaerdig", false, "bool"],
                "bevaringsaarsag_kode" => ["bevaringsvaerdig", true, "int"],
