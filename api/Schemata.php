...
class Schemata
{
    ...
    static public $schemata = [
        ...
        5607 => [
            ...
            "internationalt_id1" => ["int_id", false, "varchar"],
            "internationalt_id2" => ["int_id", false, "varchar"],
            "internationalt_id3" => ["int_id", false, "varchar"],
            "internationalt_id4" => ["int_id", false, "varchar"],
            "internationalt_id5" => ["int_id", false, "varchar"],
            "kontak_ved" => ["kontak_ved", false, "varchar"],
