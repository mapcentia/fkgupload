...
class Schemata
{
    ...
    static public $schemata = [
        ...
        5602 => [
            ...
            "p_hverdag_start" => ["p_hv_st", false, "varchar"],
            "p_hverdag_slut" => ["p_hv_sl", false, "varchar"],
            "p_loerdag_start" => ["p_loer_st", false, "varchar"],
            "p_loerdag_slut" => ["p_loer_sl", false, "varchar"],
            "p_soendag_start" => ["p_soen_st", false, "varchar"],
            "p_soendag_slut" => ["p_soen_sl", false, "varchar"],
            "p_pris_time" => ["p_pris_tim", false, "double precision"],
            "p_pris_fri_startperiode" => ["p_pris_fri", false, "int"],
            "p_start_betalingsperiode_hverdag" => ["p_stbet_hv", false, "varchar"],
            "p_slut_betalingsperiode_hverdag" => ["p_slbet_hv", false, "varchar"],
            "p_start_betalingsperiode_loerdag" => ["p_stbet_lo", false, "varchar"],
            "p_slut_betalingsperiode_loerdag" => ["p_slbet_lo", false, "varchar"],
            "p_start_betalingsperiode_soendag" => ["p_stbet_so", false, "varchar"],
            "p_slut_betalingsperiode_soendag" => ["p_slbet_so", false, "varchar"],
