...
class Schemata
{
    ...
    static public $schemata = [
        ...
        6122 => [
            ...
            "adgang_kode" => ["adgang_k", false, "int"],
            "adgang_jordarbejde_kode" => ["adg_j_k", false, "int"],
            "adgang_gartnerarbejde_kode" => ["adg_g_k", false, "int"],
            "adgang_bygningsarbejde_kode" => ["adg_b_k", false, "int"],
            ...
            "adgangsdoerhuller_staal_kode" => ["adg_s_k", false, "int"],
            "adgangsdoerhuller_staal_funktion_kode" => ["adg_s_f_k", false, "int"],
            "noedudgange_antal" => ["noed_antal", false, "int"],
            "noedudgange_staallem_kode" => ["noed_lem_k", false, "int"],
            "taarn_kode" => ["taarn_k", false, "int"],
            "betondaeksel_kode" => ["b_daksel_k", false, "int"],
            "svanehals_kode" => ["svane_k", false, "int"],
            "vvs_sump_kode" => ["vvs_sump_k", false, "int"],
            "vvs_gulvafloeb_kode" => ["vvs_gulv_k", false, "int"],
            "vvs_sump_fungerer_kode" => ["vvs_s_fu_k", false, "int"],
            "fredstidsinstallationer_kode" => ["fred_ins_k", false, "int"],
            ...
            "_1_konstruktion_blotlagt_armering_kode" => ["_1kon_ar_k", false, "int"],
            "_1_konstruktion_aendret_kode" => ["_1kon_ae_k", false, "int"],
            "_1_konstruktion_revner_gulv_kode" => ["_1kon_g_k", false, "int"],
            "_1_konstruktion_revner_vaegge_kode" => ["_1kon_v_k", false, "int"],
            "_1_konstruktion_revner_loft_kode" => ["_1kon_l_k", false, "int"],
            "_1_indtraengende_fugt_vand_kode" => ["_1i_fugt_k", false, "int"],
            "_1_vandpyt_gulv_kode" => ["_1vandpy_k", false, "int"],
            "_1_vand_daekker_gulv_kode" => ["_1vand_g_k", false, "int"],
            "_1_skadedyr_spor_kode" => ["_1dyr_sp_k", false, "int"],
            "_1_skadedyr_ekskrementer_kode" => ["_1dyr_ek_k", false, "int"],
            "_1_ventilation_haanddreven_kode" => ["_1v_haan_k", false, "int"],
            "_1_forbindelsesslanger_kode" => ["_1f_slan_k", false, "int"],
            "_1_indsugningsarrangementer_kode" => ["_1indsug_k", false, "int"],
            "_1_overtryksventiler_kode" => ["_1over_v_k", false, "int"],

            #2
            "_2_konstruktion_intakt_kode" => ["_2kon_in_k", false, "int"],
            "_2_konstruktion_blotlagt_armering_kode" => ["_2kon_ar_k", false, "int"],
            "_2_konstruktion_aendret_kode" => ["_2kon_ae_k", false, "int"],
            "_2_konstruktion_revner_gulv_kode" => ["_2kon_g_k", false, "int"],
            "_2_konstruktion_revner_vaegge_kode" => ["_2kon_v_k", false, "int"],
            "_2_konstruktion_revner_loft_kode" => ["_2kon_l_k", false, "int"],
            "_2_indtraengende_fugt_vand_kode" => ["_2i_fugt_k", false, "int"],
            "_2_vandpyt_gulv_kode" => ["_2vandpy_k", false, "int"],
            "_2_vand_daekker_gulv_kode" => ["_2vand_g_k", false, "int"],
            "_2_skadedyr_spor_kode" => ["_2dyr_sp_k", false, "int"],
            "_2_skadedyr_ekskrementer_kode" => ["_2dyr_ek_k", false, "int"],
            "_2_ventilation_haanddreven_kode" => ["_2v_haan_k", false, "int"],
            "_2_forbindelsesslanger_kode" => ["_2f_slan_k", false, "int"],
            "_2_indsugningsarrangementer_kode" => ["_2indsug_k", false, "int"],
            "_2_overtryksventiler_kode" => ["_2over_v_k", false, "int"],

            #3
            "_3_konstruktion_intakt_kode" => ["_3kon_in_k", false, "int"],
            "_3_konstruktion_blotlagt_armering_kode" => ["_3kon_ar_k", false, "int"],
            "_3_konstruktion_aendret_kode" => ["_3kon_ae_k", false, "int"],
            "_3_konstruktion_revner_gulv_kode" => ["_3kon_g_k", false, "int"],
            "_3_konstruktion_revner_vaegge_kode" => ["_3kon_v_k", false, "int"],
            "_3_konstruktion_revner_loft_kode" => ["_3kon_l_k", false, "int"],
            "_3_indtraengende_fugt_vand_kode" => ["_3i_fugt_k", false, "int"],
            "_3_vandpyt_gulv_kode" => ["_3vandpy_k", false, "int"],
            "_3_vand_daekker_gulv_kode" => ["_3vand_g_k", false, "int"],
            "_3_skadedyr_spor_kode" => ["_3dyr_sp_k", false, "int"],
            "_3_skadedyr_ekskrementer_kode" => ["_3dyr_ek_k", false, "int"],
            "_3_ventilation_haanddreven_kode" => ["_3v_haan_k", false, "int"],
            "_3_forbindelsesslanger_kode" => ["_3f_slan_k", false, "int"],
            "_3_indsugningsarrangementer_kode" => ["_3indsug_k", false, "int"],
            "_3_overtryksventiler_kode" => ["_3over_v_k", false, "int"],

            #3
            "_4_konstruktion_intakt_kode" => ["_4kon_in_k", false, "int"],
            "_4_konstruktion_blotlagt_armering_kode" => ["_4kon_ar_k", false, "int"],
            "_4_konstruktion_aendret_kode" => ["_4kon_ae_k", false, "int"],
            "_4_konstruktion_revner_gulv_kode" => ["_4kon_g_k", false, "int"],
            "_4_konstruktion_revner_vaegge_kode" => ["_4kon_v_k", false, "int"],
            "_4_konstruktion_revner_loft_kode" => ["_4kon_l_k", false, "int"],
            "_4_indtraengende_fugt_vand_kode" => ["_4i_fugt_k", false, "int"],
            "_4_vandpyt_gulv_kode" => ["_4vandpy_k", false, "int"],
            "_4_vand_daekker_gulv_kode" => ["_4vand_g_k", false, "int"],
            "_4_skadedyr_spor_kode" => ["_4dyr_sp_k", false, "int"],
            "_4_skadedyr_ekskrementer_kode" => ["_4dyr_ek_k", false, "int"],
            "_4_ventilation_haanddreven_kode" => ["_4v_haan_k", false, "int"],
            "_4_forbindelsesslanger_kode" => ["_4f_slan_k", false, "int"],
            "_4_indsugningsarrangementer_kode" => ["_4indsug_k", false, "int"],
            "_4_overtryksventiler_kode" => ["_4over_v_k", false, "int"],
        ...
        6204 => [
            ...
            "sagsnr" => ["sagsnr", false, "varchar"],
            "omraade" => ["omraade", false, "varchar"],
            "geometri_beskrivelse" => ["geom_beskr", false, "varchar"],
            "omfang" => ["omfang", false, "varchar"],
            "beskrivelse" => ["gr_beskriv", false, "varchar"],
            "registrator" => ["gr_regnavn", false, "varchar"],
        ...
        6205 => [
            ...
            "koordinat_east" => [" koord_e", false, "varchar"],
            "sagsnr" => ["sagsnr", false, "varchar"],
            "ejendomsnummer" => ["ejd_nr", false, "int"],
            "bygningsnummer" => ["byg_nr", false, "int"],
            "matrikel_ejerlav" => ["matrikel", false, "varchar"],
            "opfoerelsesaar" => ["opf_aar", false, "int"],
            "anvendelse" => ["anvendelse", false, "varchar"],
            "bbr_uuid" => ["bbr_uuid", false, "uuid"],
            "bygningsnavn" => ["byg_navn", false, "varchar"],
            "bygningsnotat" => ["byg_notat", false, "varchar"],
            ...
            "gavlkonstruktion" => ["gavl", false, "varchar"],
            "gesims" => ["gesims", false, "varchar"],
            "hovedplan" => ["hovedplan", false, "varchar"],
            "kvist" => ["kvist", false, "varchar"],
            "sokkel" => ["sokkel", false, "varchar"],
            "stilart" => ["stilart", false, "varchar"],
            "tagkonstruktion" => ["tagkonstr", false, "varchar"],
            "udsmykning" => ["udsmykning", false, "varchar"],
            "vindue" => ["vindue", false, "varchar"],
            "ydermur" => ["ydermur", false, "varchar"],
            "bebyggelsesmiljoe" => ["beb_miljoe", false, "varchar"],
            "ydre_forhold" => ["yd_forhold", false, "varchar"],
            "indre_forhold" => ["in_forhold", false, "varchar"],
            "omgivelser" => ["omgivelser", false, "varchar"],
            "arkitektonisk_vaerdi" => ["ark_kar", false, "int"],
            "arkitektonisk_vurdering" => ["ark_vurd", false, "varchar"],
            "kulturhistorisk_vaerdi" => ["kul_kar", false, "int"],
            "kulturhistorisk_vurdering" => ["kul_vurd", false, "varchar"],
            "miljoemaessig_vaerdi" => ["mil_kar", false, "int"],
            "miljoemaessig_vurdering" => ["mil_vurd", false, "varchar"],
            "originalitetsvaerdi" => ["orig_kar", false, "int"],
            "originalitetsvurdering" => ["orig_vurd", false, "varchar"],
            "tilstandsvaerdi" => ["tilst_kar", false, "int"],
            "tilstandsvurdering" => ["tilst_vurd", false, "varchar"],
            "bevaringsmaessig_vaerdi" => ["bev_kar", false, "int"],
            "bevaringsmaessig_vurdering" => ["bev_vurd", false, "varchar"],
            "registreringsdato" => ["reg_dato", false, "date"],
        ...
        5012 => [
            ...
            "ejer" => ["ejer", false, "varchar"],
            "er_del_af" => ["er_del_af", false, "varchar"],
            "etableringstidspunkt" => ["etabl_tid", false, "varchar"],
            "klimatilpasningsfunktion_afledning" => ["klt_afled", false, "bool"],
            "klimatilpasningsfunktion_fordampning" => ["klt_fordam", false, "bool"],
            "klimatilpasningsfunktion_nedsivning" => ["klt_nedsiv", false, "bool"],
            "klimatilpasningsfunktion_regulering" => ["klt_regule", false, "bool"],
            "klimatilpasningsfunktion_rensning" => ["klt_rensni", false, "bool"],
            "klimatilpasningsfunktion_reservoir" => ["klt_reserv", false, "bool"],
            "indtegningsmetode_kode" => ["indteg_m_k", false, "int"],
            "noejagtighedsklasse_kode" => ["noejagtk_k", false, "int"],
            "medietype_kode" => ["mediety_k", false, "int"],
            "forsyningsart_kode" => ["forsyn_a_k", false, "int"],
            "fareklasse_kode" => ["fareklas_k", false, "int"],
            "sikkerhedshensyn" => ["sikker_hen", false, "varchar"],
            "driftsstatus_kode" => ["drift_st_k", false, "int"],
            "ejerskabsforhold_kode" => ["ejer_for_k", false, "int"],
            "niveautype_kode" => ["niveauty_k", false, "int"],

            "tvaersnitsform_kode" => ["tvears_f_k", false, "int"],
            "udvendig_diameter" => ["udvend_dia", false, "double precision"],
            "udvendig_bredde" => ["udvend_bre", false, "double precision"],
            "udvendig_hoejde" => ["udven_hoej", false, "double precision"],
            "haeldning" => ["haeldning", false, "double precision"],
        ...
        5013 => [
            ...
            "bundkote" => ["bundkote", false, "double precision"],
            "topkote" => ["topkote", false, "double precision"],
            "haeldning" => ["haeldning", false, "double precision"],
            "permanent_vandspejlskote" => ["perm_va_ko", false, "double precision"],
            "vaadvolumen" => ["vaadvolume", false, "double precision"],
            "forsinkelsesvolumen" => ["forsin_vol", false, "double precision"],
            "gentagelsesperiode" => ["gentag_per", false, "varchar"],
            "afloebskapacitet" => ["afloeb_kap", false, "double precision"],
        ...
        5021 => [
            ...
            "topkote" => ["topkote", false, "double precision"],
            "haeldning" => ["haeldning", false, "double precision"],
            "beskrivelse" => ["breskrivel", false, "varchar"],
        ...
        5035 => [
            ...
            "projekttype_kode" => ["projek_t_k", false, "int"],
            "titel" => ["titel", false, "varchar"],
            "beskrivelse" => ["beskrivel", false, "varchar"],
            "identifikator" => ["id", false, "varchar"],
            "refererer" => ["refererer", false, "varchar"],
            "ejer" => ["ejer", false, "varchar"],
            "serviceniveau" => ["serviceniv", false, "varchar"],
            "daekker" => ["daekker", false, "varchar"],
            "rensegrad" => ["rensegrad", false, "int"],
            "samlet_afloebskapacitet" => ["afloeb_kap", false, "int"],
            "samlet_forsinkelses_volume" => ["sam_for_vo", false, "int"],
            "gentagelsesperiode" => ["gentag_per", false, "varchar"],
        ...
        5036 => [
            ...
            "titel" => ["titel", false, "varchar"],
            "beskrivelse" => ["beskrivel", false, "varchar"],
            "ekstremregn" => ["ekstremreg", false, "bool"],
            "hverdagsregn" => ["hverdagsre", false, "bool"],
